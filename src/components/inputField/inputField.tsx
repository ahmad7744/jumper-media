        ...
        <div className={`grid w-full items-center gap-2.5 Inter ${sizeClasses}`}>
            ...
            <div className="relative ">
                ...
                <Input
                    ...
                    value={value}
                    onChange={onChange}
                    className={`w-full placeholder:text-zinc-300 text-zinc-300 border-[1px] border-zinc-800  rounded-[8px] ${backgroundColor === 'light' ? 'bg-zinc-800' : 'bg-zinc-900'} ${size === 'small' ? 'pl-8 ' : 'pl-8  '} `}
                />
